...
Till now, we are getting random projects and we are containerizing the project into an image and deploying a container
...
Deployment methods
1. Master node + Worker node on a single
2. Complex with master and worker nodes - Most economical and flexible
3. AKS 
